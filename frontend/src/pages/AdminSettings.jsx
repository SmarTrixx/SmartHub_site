    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0057FF] to-cyan-600 p-8">
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="text-white/80 mt-2">Configure email credentials and system status</p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white/10 backdrop-blur-xl rounded-lg p-8 border border-white/20 mb-6">
          ...
          <div className="space-y-6">
            <div className="bg-white/5 rounded-lg p-6 border border-white/10">
              <h3 className="text-lg font-semibold text-white mb-4">Primary Email Account</h3>
              <div className="space-y-3">
                ...
                <div className="text-white/60 text-sm">
                  <p>📧 Uses: <span className="text-white">GMAIL_USER and GMAIL_PASSWORD</span></p>
                  <p>💌 Purpose: <span className="text-white">Contact form and notifications</span></p>
                </div>
              </div>
            </div>

            <div className="bg-white/5 rounded-lg p-6 border border-white/10">
              <h3 className="text-lg font-semibold text-white mb-4">Secondary Email Account</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-white/60 text-sm">Account</p>
                ...
                <div className="text-white/60 text-sm">
                  <p>📧 Uses: <span className="text-white">GMAIL_USER_SECONDARY and GMAIL_PASSWORD_SECONDARY</span></p>
                  <p>💌 Purpose: <span className="text-white">Optional backup or studio emails</span></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="mt-6 bg-blue-50/10 border border-blue-400/30 rounded-lg p-6 text-white">
          <h3 className="font-semibold mb-4">Configuration Instructions</h3>
          <div className="text-sm space-y-2 text-white/80">
            <p>1. To use dual email credentials, set the following environment variables:</p>
            <div className="bg-black/30 p-3 rounded font-mono text-xs mt-2 space-y-1">
            ...
            <p className="mt-3">2. Secondary email is optional and can be used for studio-specific communications</p>
            <p>3. App passwords are recommended over regular Gmail passwords for security</p>
          </div>
        </motion.div>
      </div>
    </div>
